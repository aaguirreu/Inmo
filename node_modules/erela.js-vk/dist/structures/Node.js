...
class Node {
    ...
    constructor(options) {
        ...
        check(options);
        this.options = Object.assign({ port: 2333, password: "youshallnotpass", secure: false, retryAmount: Number.MAX_SAFE_INTEGER, retryDelay: Number.MAX_SAFE_INTEGER }, options);
